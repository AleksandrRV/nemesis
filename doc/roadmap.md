...
* **Пакет источника:** `data-sources.json#deck-composition` `EXTERNAL_UNVERIFIED` (нет сканов, есть транскрипты владельца), golden-тест `sources.golden.test.ts` сверяет количества 60/30/30/30/12/27/16 и уникальность ID.
