...
| `eventsPhase.ts` | `runEventPhase()`, `advanceTimeAndSelfDestruct()`, `resolveFireDamage()` | Оркестратор Фазы Событий (стр. 10): Шаг 4 — маркеры Времени и Самоуничтожения с аварийными финалами (`HYPERSPACE_JUMP`, `SHIP_EXPLODED`, разблокировка Капсул с жёлтой зоны); Шаг 6 — 1 Рана каждому Чужому в горящем отсеке с проверкой Стойкости и уничтожением одного Яйца на полу; Шаги 5/7/8 честно пропускаются журналом до следующих шагов этапа 0.5.0. |
