  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'door-leaf-slam': {
          '0%': { transform: 'translateY(var(--door-travel))' },
          '64%': { transform: 'translateY(0)' },
          '74%': { transform: 'translateY(calc(var(--door-travel) * -0.1))' },
          '86%': { transform: 'translateY(0)' },
          '93%': { transform: 'translateY(calc(var(--door-travel) * -0.03))' },
          '100%': { transform: 'translateY(0)' },
        },
        'door-leaf-retract': {
          '0%': { transform: 'translateY(0)' },
          '12%': { transform: 'translateY(calc(var(--door-travel) * 0.08))' },
          '22%': { transform: 'translateY(calc(var(--door-travel) * 0.03))' },
          '100%': { transform: 'translateY(var(--door-travel))' },
        },
        'door-impact-shake': {
          '0%, 100%': { transform: 'translate(0, 0)' },
          '18%': { transform: 'translate(1.4px, 0.2px)' },
          '36%': { transform: 'translate(-1.1px, -0.2px)' },
          '54%': { transform: 'translate(0.7px, 0.1px)' },
          '72%': { transform: 'translate(-0.4px, 0)' },
        },
        'door-seam-flash': {
          '0%': { opacity: '0' },
          '18%': { opacity: '1' },
        ...
        'door-puff': {
          '0%': { opacity: '0.85', transform: 'translate(0, 0) scale(0.4)' },
          '100%': { opacity: '0', transform: 'translate(var(--puff-x), var(--puff-y)) scale(1.7)' },
        },
        'door-led-blink': {
          '0%, 36%, 72%, 100%': { opacity: '1' },
          '18%, 54%': { opacity: '0.12' },
        },
        'door-seal-pulse': {
          '0%, 100%': { opacity: '0.45' },
        ...
        'door-strain': {
          '0%, 100%': { transform: 'translate(0, 0)' },
          '10%': { transform: 'translate(0.6px, 0.3px)' },
          '20%': { transform: 'translate(-0.8px, -0.2px)' },
          '30%': { transform: 'translate(1px, 0.3px)' },
          '40%': { transform: 'translate(-1.1px, -0.1px)' },
          '50%': { transform: 'translate(1.3px, -0.3px)' },
          '60%': { transform: 'translate(-1.4px, 0.3px)' },
          '70%': { transform: 'translate(1.6px, 0.1px)' },
          '80%': { transform: 'translate(-1.7px, -0.3px)' },
          '90%': { transform: 'translate(1.9px, 0.2px)' },
        },
        'door-heat': {
          '0%': { opacity: '0' },
          '100%': { opacity: '0.9' },
        ...
        'door-shrapnel': {
          ...
          '70%': { opacity: '1' },
          '100%': { opacity: '0', transform: 'translate(var(--shard-x), var(--shard-y)) rotate(var(--shard-rot))' },
        },
        'door-spark-fly': {
          '0%': { opacity: '0', transform: 'translate(0, 0) scale(1)' },
          '10%': { opacity: '1' },
          '100%': { opacity: '0', transform: 'translate(var(--spark-x), var(--spark-y)) scale(0.3)' },
        },
        'door-smoke': {
          '0%': { opacity: '0', transform: 'translate(0, 0) scale(0.4)' },
          '25%': { opacity: '0.55' },
          '100%': { opacity: '0', transform: 'translate(var(--puff-x), var(--puff-y)) scale(2.3)' },
        },
        'door-wreck-reveal': {
          '0%': { opacity: '0' },
          '100%': { opacity: '1' },
      ...
      animation: {
        ...
        'door-leaf-slam': 'door-leaf-slam 620ms cubic-bezier(0.6, 0, 0.9, 0.5) both',
        'door-leaf-retract': 'door-leaf-retract 820ms cubic-bezier(0.45, 0.05, 0.3, 1) both',
        'door-impact-shake': 'door-impact-shake 360ms ease-out both',
        'door-seam-flash': 'door-seam-flash 560ms ease-out both',
        'door-bolt-lock': 'door-bolt-lock 280ms ease-out both',
        'door-bolt-release': 'door-bolt-release 220ms ease-in both',
        'door-puff': 'door-puff 720ms ease-out both',
        'door-led-blink': 'door-led-blink 760ms linear both',
        'door-seal-pulse': 'door-seal-pulse 2.4s ease-in-out infinite',
        'door-strain': 'door-strain 520ms linear both',
        'door-heat': 'door-heat 520ms ease-in both',
        'door-ghost-hold': 'door-ghost-hold 520ms linear both',
        'door-blast-flash': 'door-blast-flash 640ms ease-out both',
        'door-blast-wave': 'door-blast-wave 900ms ease-out both',
        'door-shrapnel': 'door-shrapnel 880ms cubic-bezier(0.1, 0.7, 0.3, 1) both',
        'door-spark-fly': 'door-spark-fly 640ms ease-out both',
        'door-smoke': 'door-smoke 1300ms ease-out both',
        'door-wreck-reveal': 'door-wreck-reveal 420ms ease-out both',
        'door-ember': 'door-ember 1.6s ease-in-out infinite',
        'door-led-flicker': 'door-led-flicker 3.4s linear infinite',
        'door-fx-gate': 'door-fx-gate 1600ms linear both',
        'crew-active-ring': 'crew-active-ring 1.8s ease-out infinite',
        'crew-active-spin': 'crew-active-spin 9s linear infinite',
        'log-ticker': 'log-ticker 40s linear infinite',
        'log-ticker-flash': 'log-ticker-flash 1.6s ease-out both',
      },
      boxShadow: {
